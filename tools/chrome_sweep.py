...
CHECKS: list[tuple[str, str, str]] = [
    ...
    # Batch 22 improvements (I-26, I-93, I-129, I-135, I-136, I-138-I-140):
    # one anchored section each.
    ("B22-I26", "/status",
     "() => !!document.querySelector('#status-b22-tztime')"),
    ("B22-I93", "/status",
     "() => !!document.querySelector('#status-b22-timetag')"),
    ("B22-I129", "/status",
     "() => !!document.querySelector('#status-b22-realfile')"),
    ("B22-I135", "/status",
     "() => !!document.querySelector('#status-b22-regenstat')"),
    ("B22-I136", "/status",
     "() => !!document.querySelector('#status-b22-abphrase')"),
    ("B22-I138", "/status",
     "() => !!document.querySelector('#status-b22-readout')"),
    ("B22-I139", "/status",
     "() => !!document.querySelector('#status-b22-dyslexia')"),
    ("B22-I140", "/status",
     "() => !!document.querySelector('#status-b22-calmreplay')"),
    # Batch 22 features (F-102-F-105, F-107-F-110): anchored sections.
    ("B22-F102", "/status",
     "() => !!document.querySelector('#status-b22-ownhead')"),
    ("B22-F103", "/status",
     "() => !!document.querySelector('#status-b22-growrings')"),
    ("B22-F104", "/status",
     "() => !!document.querySelector('#status-b22-knowngarden')"),
    ("B22-F105", "/status",
     "() => !!document.querySelector('#status-b22-timeledger')"),
    ("B22-F107", "/status",
     "() => !!document.querySelector('#status-b22-milestones')"),
    ("B22-F108", "/status",
     "() => !!document.querySelector('#status-b22-sharecards')"),
    ("B22-F109", "/status",
     "() => !!document.querySelector('#status-b22-learnresume')"),
    ("B22-F110", "/status",
     "() => !!document.querySelector('#status-b22-endorse')"),
    # Batch 22 live surfaces: History proof block, UTC stamps, toggles.
    ("B22-F102-live", "/reviews",
     "() => !!document.querySelector('#owned-headline')"),
    ...
    ("B22-F107-live", "/reviews",
     "() => !!document.querySelector('#milestones')"),
    ("B22-F108-live", "/reviews",
     "() => !!document.querySelector('#share-cards')"),
    ("B22-F109-live", "/reviews",
     "() => !!document.querySelector('#learning-resume')"),
    ("B22-F110-live", "/reviews",
     "() => !!document.querySelector('#endorsements')"),
    ("B22-I26-live", "/reviews",
     "() => !!document.querySelector(\"time[title*='UTC']\")"),
    ("B22-I93-live", "/reviews",
     "() => !!document.querySelector('time[datetime]')"),
    ("B22-I139-live", "/",
     "() => !!document.querySelector('#gw-dys-toggle')"),
    ("B22-I138-live", "/",
     "() => !!document.querySelector('script[data-readaloud]')"),
    ("B22-I140-live", "/",
     "() => !!document.querySelector('script[data-calm-replay]')"),
    # Batch 23 improvements (I-141, I-143-I-146, I-148-I-150):
    # one anchored section each.
    ("B23-I141", "/status",
     "() => !!document.querySelector('#status-b23-audiosum')"),
    ("B23-I143", "/status",
     "() => !!document.querySelector('#status-b23-buddyview')"),
    ("B23-I144", "/status",
     "() => !!document.querySelector('#status-b23-readnudge')"),
    ("B23-I145", "/status",
     "() => !!document.querySelector('#status-b23-diffvote')"),
    ("B23-I146", "/status",
     "() => !!document.querySelector('#status-b23-diffweights')"),
    ("B23-I148", "/status",
     "() => !!document.querySelector('#status-b23-unlockfx')"),
    ("B23-I149", "/status",
     "() => !!document.querySelector('#status-b23-weekdigest')"),
    ("B23-I150", "/status",
     "() => !!document.querySelector('#status-b23-archiveless')"),
    # Batch 23 features (F-111-F-117, F-119): anchored sections.
    ("B23-F111", "/status",
     "() => !!document.querySelector('#status-b23-partytrick')"),
    ("B23-F112", "/status",
     "() => !!document.querySelector('#status-b23-teachcert')"),
    ("B23-F113", "/status",
     "() => !!document.querySelector('#status-b23-conceptbadges')"),
    ("B23-F114", "/status",
     "() => !!document.querySelector('#status-b23-showcase')"),
    ("B23-F115", "/status",
     "() => !!document.querySelector('#status-b23-themeunlock')"),
    ("B23-F116", "/status",
     "() => !!document.querySelector('#status-b23-avatar')"),
    ("B23-F117", "/status",
     "() => !!document.querySelector('#status-b23-mascot')"),
    ("B23-F119", "/status",
     "() => !!document.querySelector('#status-b23-focustimer')"),
    # Batch 23 live surfaces: Due trick/mascot/timer, History proof
    # sections, the global audio wire.
    ("B23-F111-live", "/due",
     "() => !!document.querySelector('#partytrick')"),
    ("B23-F117-live", "/due",
     "() => !!document.querySelector('#mascot')"),
    ("B23-F119-live", "/due",
     "() => !!document.querySelector('#focus-timer')"),
    ("B23-F112-live", "/reviews",
     "() => !!document.querySelector('#teaching-certificates')"),
    ("B23-F114-live", "/reviews",
     "() => !!document.querySelector('#showcase')"),
    ("B23-F115-live", "/reviews",
     "() => !!document.querySelector('#theme-unlocks')"),
    ("B23-F116-live", "/reviews",
     "() => !!document.querySelector('#library-identity')"),
    ("B23-I141-live", "/",
     "() => !!document.querySelector('script[data-audiosum]')"),
    # Batch 24 improvements (I-154-I-161): one anchored section each.
    ("B24-I154", "/status",
     "() => !!document.querySelector('#status-b24-codeedit')"),
    ("B24-I155", "/status",
     "() => !!document.querySelector('#status-b24-runkey')"),
    ("B24-I156", "/status",
     "() => !!document.querySelector('#status-b24-sandout')"),
    ("B24-I157", "/status",
     "() => !!document.querySelector('#status-b24-outdiff')"),
    ("B24-I158", "/status",
     "() => !!document.querySelector('#status-b24-reveal')"),
    ("B24-I159", "/status",
     "() => !!document.querySelector('#status-b24-giveup')"),
    ("B24-I160", "/status",
     "() => !!document.querySelector('#status-b24-partial')"),
    ("B24-I161", "/status",
     "() => !!document.querySelector('#status-b24-retryblanks')"),
    # Batch 24 features (F-120, F-122-F-128): anchored sections.
    ("B24-F120", "/status",
     "() => !!document.querySelector('#status-b24-playlists')"),
    ("B24-F122", "/status",
     "() => !!document.querySelector('#status-b24-restday')"),
    ("B24-F123", "/status",
     "() => !!document.querySelector('#status-b24-comeback')"),
    ("B24-F124", "/status",
     "() => !!document.querySelector('#status-b24-antistreak')"),
    ("B24-F125", "/status",
     "() => !!document.querySelector('#status-b24-buddyping')"),
    ("B24-F126", "/status",
     "() => !!document.querySelector('#status-b24-buddymatch')"),
    ("B24-F127", "/status",
     "() => !!document.querySelector('#status-b24-coop')"),
    ("B24-F128", "/status",
     "() => !!document.querySelector('#status-b24-wagers')"),
    # Batch 24 live surfaces: Due playlists, History pledge + ledger.
    ("B24-F120-live", "/due",
     "() => !!document.querySelector('#playlists')"),
    ("B24-F124-live", "/reviews",
     "() => !!document.querySelector('#antistreak')"),
    ("B24-F128-live", "/reviews",
     "() => !!document.querySelector('#status-wagers')"),
]
