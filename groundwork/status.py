...
from . import batch10 as batch10mod, batch11 as batch11mod, batch12 as batch12mod, batch13 as batch13mod
...
def page_html(db_path: str) -> str:
    ...
    return "".join([
        ...
        batch7_html(db_path) +
        batch8_html() +
        batch9_html() + batch10mod.batch10_html() + batch11mod.batch11_html() + batch12mod.batch12_html() + batch13mod.batch13_html() +
