...
from . import batch10 as batch10mod, batch11 as batch11mod, batch12 as batch12mod, batch13 as batch13mod, batch18 as batch18mod, batch19 as batch19mod, batch20 as batch20mod, batch21 as batch21mod, batch22 as batch22mod, batch23 as batch23mod, batch24 as batch24mod
...
def page_html(db_path: str) -> str:
    ...
    return "".join([
        ...
        batch7_html(db_path) +
        batch8_html() +
        batch9_html() + batch10mod.batch10_html() + batch11mod.batch11_html() + batch12mod.batch12_html() + batch13mod.batch13_html() + batch18mod.batch18_html() + batch19mod.batch19_html() + batch20mod.batch20_html() + batch21mod.batch21_html() + batch22mod.batch22_html(db_path) + batch23mod.batch23_html(db_path) + batch24mod.batch24_html(db_path) +
